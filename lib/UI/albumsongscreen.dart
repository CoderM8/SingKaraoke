...
class AlbumSongScreen extends StatelessWidget {
  const AlbumSongScreen({super.key, required this.albumId, required this.albumName, this.isBack = false});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(text: albumName, fontFamily: 'M', fontSize: 18.sp),
        centerTitle: true,
      ),
                  ...
                  itemBuilder: (con, i) {
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        //      .whenComplete(() => Get.to(() => PlayerScreen(musicType: MusicType.album, id: albumId, name: albumName))));
                      },
                      child: SizedBox(
                        height: 50.h,
                        child: Row(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextWidget(text: songs.artist!, fontSize: 10.sp, textAlign: TextAlign.start, overflow: TextOverflow.ellipsis),
                                ],
                              ),
                            ),
                            SizedBox(width: 10.w),
